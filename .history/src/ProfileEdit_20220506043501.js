...
function ProfileEdit() {
    ...
    const [email, setWhatsapp] = useState("")
    ...
    return (
        <div className="dashboard">
            <div className="dashboard__container">           
                ...
                <input placeholder="Mude seu whatsapp" type='text' name='whatsapp' required onChange={(e) => setWhatsapp(e.target.value)} />                </form>  
                <input placeholder="Mude sua descricao" type='text' name='descricao' required onChange={(e) => setDescricao(e.target.value)} />
                <input placeholder="Mude seu email" type='text' name='email' required onChange={(e) => setEmail(e.target.value)} />
            </div>
        </div>
    );
}
