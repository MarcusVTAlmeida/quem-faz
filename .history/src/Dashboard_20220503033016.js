...
import { query, collection, getDocs, where, doc, addDoc, setDoc, updateDoc, getDoc } from "firebase/firestore";
...
function Dashboard() {
  ...
  const returnCidades = async () => {
    const taskColRef = query(collection(db, 'userus'), orderBy('created', 'desc'))
